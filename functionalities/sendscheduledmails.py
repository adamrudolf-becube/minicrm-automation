...
def send_scheduled_emails(crm_data):
    ...
    active_students = crm_data.get_student_list_with_status("Kurzus folyamatban")

    trace("SPECTATORS: ")
    spectators = crm_data.get_student_list_with_status("Megfigyelő")
    ...
    for student in student_list:
        ...
        if crm_data.get_today() >= datetime.datetime.strptime(student_data["N10Alkalom2"], "%Y-%m-%d %H:%M:%S"):
