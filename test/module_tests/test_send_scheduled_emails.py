...
class TestSendScheduledMails(MiniCrmTestBase):
    ...
    def test_advanced_date_is_before_1st_occasion_but_difference_is_less_than_delta_send_first_email(self):
        ...
        self.command_handler.expect_command(
            self.crm_command_factory.set_project_data(2941, {u"Levelkuldesek":u"Kezd\u0151 INFO lev\u00e9l, 1. alkalom - halad\u00f3"}),
            apioutputs_general.XPUT_RESPONSE
        )
        send_scheduled_emails(self.crm_data)
    ...
    def test_advanced_if_no_mails_have_been_sent_but_more_occasions_passed_send_all_relevant_emails(self):
        ...
        self.command_handler.expect_command(
            self.crm_command_factory.set_project_data(2941, {u"Levelkuldesek": u"Kezd\u0151 INFO lev\u00e9l, 1. alkalom - halad\u00f3, 2. alkalom - halad\u00f3, 3. alkalom - halad\u00f3, 4. alkalom - halad\u00f3"}),
            apioutputs_general.XPUT_RESPONSE
        )
        send_scheduled_emails(self.crm_data)
    ...
    def test_advanced_if_second_break_is_coming_send_second_break_email(self):
        ...
        self.command_handler.expect_command(
            self.crm_command_factory.set_project_data(2941, {u"Levelkuldesek": u"Kezd\u0151 INFO lev\u00e9l, 1. alkalom - halad\u00f3, 2. alkalom - halad\u00f3, 3. alkalom - halad\u00f3, 4. alkalom - halad\u00f3, 5. alkalom - halad\u00f3, 6. alkalom - halad\u00f3, 7. alkalom - halad\u00f3, 1. sz\u00fcnet, 2. sz\u00fcnet"}),
            apioutputs_general.XPUT_RESPONSE
        )
        send_scheduled_emails(self.crm_data)
