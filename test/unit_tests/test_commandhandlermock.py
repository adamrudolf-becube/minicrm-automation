...
class TestCommandHandlerMock(unittest.TestCase):
    ...
    def test_expectations_are_matched_in_correct_order(self):
        self.command_handler.expect_command(crmrequestfactory.get_student(42), 'b')
        self.command_handler.expect_command(crmrequestfactory.get_student(43), 'd')
        self.command_handler.expect_command(crmrequestfactory.get_student(44), 'f')
        self.command_handler.match_expectation(crmrequestfactory.get_student(42))
